...
public class RestApp {
    ...
    private static final URI BASE_URI = URI.create("http://0.0.0.0:8080/v1/");

    public static void main(String[] args) {
        try {
            System.out.println("listen on http://0.0.0.0:8080/v1/");
            ...
            Logger.getLogger(RestApp.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
